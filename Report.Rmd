...
# Knitr Configuration
knitr::opts_chunk$set(cache = TRUE, include=TRUE, echo=FALSE, results="markup", fig.show= "asis", fig.height = 4)
```
...
summary(engineeredBirthWeightModel)
...
```{r leverage}
#cook's distance vs. leverage for Model 1
...
#cook's distance vs. leverage for Model 2
...
par(mfrow=c(2,2))
plot(cvResults$residuals$actual, cvResults$residuals$model1)
plot(cvResults$residuals$actual, cvResults$residuals$model2)
plot(cvResults$residuals$model1Predictions, cvResults$residuals$model1)
plot(cvResults$residuals$model2Predictions, cvResults$residuals$model2)
```
...
qqnorm(cvResults$residuals$model1, main = "Normal Q-Q Plot for Model 1")
abline(a = 0, b = 20, lty = 2, col = "blue")

qqnorm(cvResults$residuals$model2, main = "Normal Q-Q Plot for Model 2")
abline(a = 0, b = 20, lty = 2, col = "blue")
