...
```{r leverage}
#leveragePlots(basicBirthWeightModel)
#leveragePlots(engineeredBirthWeightModel)
...
cex <- .8
plot(h, D, xlab = "Leverage", ylab = "Cook's Influence Measure", main = "Leverage Plot for Model 1", pch = 21, bg = clrs, cex = cex, cex.axis = cex)
...
par(mfrow = c(1,1), mar = c(4,4,1,1))
cex <- .8
plot(h, D, xlab = "Leverage", ylab = "Cook's Influence Measure", main = "Leverage Plot for Model 2", pch = 21, bg = clrs, cex = cex, cex.axis = cex)
