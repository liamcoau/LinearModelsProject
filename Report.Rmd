...
Returns the best model as chosen by automated model selection. Discussed and appears in Candidate Model 1.
```{r ref.label = "model1"}
```

### Chunk 2

Returns the best model including the engineered variables as chosen by automated model selection. Discussed and appears in Candidated Model 2.
```{r ref.label = "model2"}
```
