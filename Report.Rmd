...
The second reason we did not remove these variables was because of the percentage of the population that fell under those categories. For example, the number of people who Quit But Didn't Know When was very small: only 0.4% (See Appendix 3.3.7). This results in a large p-value as their results are less representative of the population than that of a more significant sample.
