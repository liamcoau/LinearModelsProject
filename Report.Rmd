...
By looking at the plot of Cook's distance of the two models in Appendix 3.3.2 and Appendix 3.3.3, there is around the same number fo high influential data points in the model. The Engineered Model's data is overall more influential compared to the Basic model.
...
Another reason we did not remove these variables was because of the percentage of the population that fell under those categories. For example, the number of people who Quit But Didn't Know When was very small: only 0.4% (See Appendix 3.3.7). This results in a large p-value as their results are less representative of the population than that of a more significant sample.
...
### Figure 3.2
Cook's Distance plot for Basic Model - Appears in Model Selection.
...
### Figure 3.3
Cook's Distance plot for Engineered Model - Appears in Model Selection.
...
Produces a Residual vs Fitted, Normal QQ, and Scale-Location plot for the Engineered Model. Appears in Discussion.
