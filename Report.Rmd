...
# Knitr Configuration
knitr::opts_chunk$set(include=TRUE, echo=FALSE, results="markup", fig.show= "asis", fig.height = 4)
```
...
qqplot(cvResults$residuals$model1Predictions,cvResults$residuals$actual, main = "Q-Q Plot", xlab = "Predicted Values", ylab = "Actual Values")
abline(a = 0, b = 1, lty = 2, col = "red")

qqplot(cvResults$residuals$model2Predictions,cvResults$residuals$actual, main = "Q-Q Plot", xlab = "Predicted Values", ylab = "Actual Values")
abline(a = 0, b = 1, lty = 2, col = "red")
```
