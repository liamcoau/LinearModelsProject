...
Looking at the p-values of the Engineered Model in Appendix 3.3.4, the most important factors that affects a babies weight is the time since the mother quit smoking, the mother's ethnicity, the mother's height, the mBMI, and the parity, with the most significant being the 
