...
craftFeatures <- function (imputedBirthsDataset, impactHalfLife = 2) {
  ...
  # Note: This treats parents of "Mixed" and "Other" ethnicities
  # as the same ethnicity though for arguably babies of two parents
  # of "Mixed" ethnicity end up as "Mixed" which is the interpretation
  # of this feature being "FALSE"
...
Looking at the p-values of the Engineered Model in Appendix 3.3.4, the most important factors that affects a babies weight is the time since the mother quit smoking, the mother's ethnicity, the mother's height, the mBMI, and the parity, with the most significant being the mother's ethinicity and height. 
...
sapply(0:9, function(i) sum(na.omit(births$time == i))/1236)
```
