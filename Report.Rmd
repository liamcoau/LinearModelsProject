...
plot(basicBirthWeightModel, which = c(2, 1), cex = 0.4, pch = 19, main = NULL)
...
```{r plot diagnostic 2}
layout(matrix(c(1, 2, 4, 5), 1, 2, byrow = TRUE))
plot(engineeredBirthWeightModel, which = c(2, 1), cex = 0.4, pch = 19, main = NULL)
```
...
legend("topleft", legend = c("High Leverage", "High Influence"), pch = 21,pt.bg = c("blue", "red"), cex = cex, pt.cex = 0.8)
...
legend(
  "topleft",
  legend = c("High Leverage", "High Influence"),
  pch = 21,
  pt.bg = c("blue", "red"),
  cex = 0.5,
  pt.cex = cex
